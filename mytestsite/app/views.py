...
class LoanedBooksByUserListView(LoginRequiredMixin, generic.ListView):
    ...
    model = BookInstance
    template_name = 'app/bookinstance_list_borrowed_user.html'
    paginate_by = 10
...
class LoanedBooksAllListView(PermissionRequiredMixin, generic.ListView):
    ...
    model = BookInstance
    permission_required = 'app.can_mark_returned'
    template_name = 'app/bookinstance_list_borrowed_all.html'
    paginate_by = 10
...
from app.forms import RenewBookForm


@login_required
@permission_required('app.can_mark_returned', raise_exception=True)
def renew_book_librarian(request, pk):
    ...
    return render(request, 'app/book_renew_librarian.html', context)
...
class GenreUpdate(PermissionRequiredMixin, UpdateView):
    model = Genre
    fields = ['name', ]
    permission_required = 'app.change_genre'


class GenreDelete(PermissionRequiredMixin, DeleteView):
    model = Genre
    success_url = reverse_lazy('genres')
    permission_required = 'app.delete_genre'
...
class LanguageUpdate(PermissionRequiredMixin, UpdateView):
    model = Language
    fields = ['name', ]
    permission_required = 'app.change_language'


class LanguageDelete(PermissionRequiredMixin, DeleteView):
    model = Language
    success_url = reverse_lazy('languages')
    permission_required = 'app.delete_language'
...
class BookInstanceUpdate(PermissionRequiredMixin, UpdateView):
    ...
    permission_required = 'app.change_bookinstance'


class BookInstanceDelete(PermissionRequiredMixin, DeleteView):
    model = BookInstance
    success_url = reverse_lazy('bookinstances')
    permission_required = 'app.delete_bookinstance'